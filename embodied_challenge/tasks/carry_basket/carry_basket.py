...
class CarryBasketEnvV2(EmbodiedEnv):
    def __init__(self, cfg: EmbodiedEnvCfg = None, **kwargs):
        ...
        # Defaults used by carry_basket action config.
    ...
    def create_demo_action_list(self, *args, **kwargs):
        logger.log_info("Create demo action list for CarryBasketTask.")
        ...
        self._init_action_bank(CarryBasketActionBank, self.action_config)
